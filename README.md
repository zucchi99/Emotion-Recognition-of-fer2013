...
The class has following parameters (divided by which step are used):
 ...
 3. <i>List( Inception-Block )</i>:
   ...
   * <i>integer</i> <code>incep__multiplier</code>: multiplier applied to the default out dimension of resnet: (64 for 1x1, 128 per 3x3, 32 per 5x5, 32 per maxpool), for ex. if setted to $2$ will have $2 * 64$ for 1x1, $2 * 128$ for 3x3 ecc.
 4. <i>DropOut</i>:
